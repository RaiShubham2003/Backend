...
const generateAccessToken_and_refereshToken = async (userId) => {
    try {
...
const loginUser = asyncHandler( async (req, res ) => {
    ...
    const { accessToken, refreshToken } = await generateAccessToken_and_refereshToken(user._id)
...
const refreshAccessToken = asyncHandler( async (req, res) => {
    ...
    const { accessToken, newRefreshToken } = generateAccessToken_and_refereshToken(user._id)
...
const updatePassword = asyncHandler( async (req, res) => {
    ...
    if (( !(oldPassword && newPassword) )){
        throw new ApiError(400, "Please enter the required details")
    }
